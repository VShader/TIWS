...
\subsection{Def.: (Relation, Prädikat)}
\begin{itemize}
	\item a) Eine n-stellige Relation über Menge M ist eine Teilmenge des n-fachen Kartesischen 			Produkts}
			M x...x M = $M^$n über M
			  n-mal
	...
	Def.:
	\item b) Prädikat n-stelliges Prädikat über M ist eine Funktion P:$M^$n->{0,1}
	\item c) n-stelliges Prädikat P zur n-stellien Relation R
